...
import random
import my_module #importing another file to use the content form it

#Checks number between 1 and 10
random_integer = random.randint(1, 10)
print(random_integer)

# uses the file name and the variable inside it
print(my_module.my_favorite_number)


#Random Module and the random function together
...
#Task 1: Create a program that generates heads or tails
...
"""
-  A random module is a python module which means to prevent code from getting too 
big we split the functionality into modules. If its a  
large project we can get other people involved to help 
with the project in specific modules.

- Right click on the folder and click new and pick python file to create a module.
- Semi open range multiplying to change the range of random.random
