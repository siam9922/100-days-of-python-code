...
#when you import something from a module if you
# just import hangman.words you have to write it with dots hangman_words.wordlist
#short way to write is from hangman_words import word_list