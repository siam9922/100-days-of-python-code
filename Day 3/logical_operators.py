...
# - Logical operators are used in python to combine different conditions

#   1. This is the AND operator.    Example: A and B #Both conditions need to be true
#   2. This is the OR operator.     Example: C or D #Only one condition needs to be true
#   3. This is the NOT operator     Example: This reverses a condition if the result is True or False.

# - Alt + shift + E to access python console